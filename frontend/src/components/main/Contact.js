...
const Contact = () => {
  return (
    <div>
      <div style={{ backgroundColor: 'rgb(238, 238, 238)', backgroundSize: 'cover', backgroundPosition: 'bottom' }}>
      ...
      <img src="/img/contact us pic.jpg" alt="contact us photo" className='w-100 img-thumbnail'/>
          ...
          {/* <div className="col-md-6 my-5 "> */}
          <div className="card my-5 mx-auto  p-2" style={{ height: '75vh', width: '50%' }}>
